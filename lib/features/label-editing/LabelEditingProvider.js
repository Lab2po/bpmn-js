...
LabelEditingProvider.prototype.getEditingBBox = function(element) {
  ...
  var smallFontSize = externalStyle.fontSize * zoom,
      smallLineHeight = externalStyle.lineHeight * zoom,
      mediumFontSize = defaultStyle.fontSize * zoom,
      mediumLineHeight = defaultStyle.lineHeight * zoom;
