...
export default function BpmnRenderer(
  ...
  function createMarker(type, fill, stroke) {
    ...
    if (type === 'sequenceflow-end') {
      ...
      var sequenceflowEnd = rc.path('M 1 5 L 11 10 L 1 15 Z', {
        roughness: 0.5,
        fillStyle: 'solid',
        fill: stroke,
        stroke: stroke
    ...
    if (type === 'messageflow-start') {
      ...
      var messageflowStart = rc.circle(6, 6, 5, {
        roughness: 0.3,
        fillStyle: 'solid',
        fill: fill,
        stroke: stroke
    ...
    if (type === 'messageflow-end') {
      ...
      var messageflowEnd = rc.path('m 1 5 l 0 -3 l 7 3 l -7 3 z', {
        roughness: 0.5,
        fillStyle: 'solid',
        fill: fill,
        stroke: stroke
    ...
    if (type === 'association-start') {
      ...
      var associationStart = rc.path('M 11 5 L 1 10 L 11 15', {
        roughness: 0.5,
        stroke: stroke
      });
    ...
    if (type === 'association-end') {
      ...
      var associationEnd = rc.path('M 1 5 L 11 10 L 1 15', {
        roughness: 0.5,
        stroke: stroke
      });
    ...
    if (type === 'conditional-flow-marker') {
      ...
      var conditionalflowMarker = rc.path('M 0 10 L 8 6 L 16 10 L 8 14 Z', {
        roughness: 0.5,
        stroke: stroke
      });
    ...
    if (type === 'conditional-default-flow-marker') {
      ...
      var conditionaldefaultflowMarker = rc.path('M 6 4 L 10 16', {
        roughness: 0.5,
        stroke: stroke
      });
  ...
  function drawLine(parentGfx, waypoints, attrs, hints) {
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:BusinessRuleTask': function(parentGfx, element) {
      ...
      var businessHeaderPath = drawPath(parentGfx, headerPathData, { roughness: 0.5 });
      ...
      var businessPath = drawPath(parentGfx, headerData, { roughness: 0.5 });
    ...
    'bpmn:Transaction': function(parentGfx, element) {
      ...
      //   x: element.x + 2 * INNER_OUTER_DIST,
      //   y: element.y + 2 * INNER_OUTER_DIST,
      //   width: element.width - 4 * INNER_OUTER_DIST,
      //   height: element.height - 4 * INNER_OUTER_DIST
      // }, TASK_BORDER_RADIUS);
    ...
    'bpmn:EventBasedGateway': function(parentGfx, element) {
      ...
      if (type === 'Parallel') {
        ...
        if (!instantiate) {
          var innerCircle = drawCircle(parentGfx, element.width, element.height, element.height * 0.55);
          svgAttr(innerCircle, {
            strokeWidth: 1,
            fill: 'none',
            stroke: getStrokeColor(element)
    ...
    'bpmn:SequenceFlow': function(parentGfx, element) {
      ...
      var path = drawPath(parentGfx, pathData, attrs, { isConnection: true });
    ...
    'bpmn:Association': function(parentGfx, element, attrs) {
      ...
      return drawLine(parentGfx, element.waypoints, attrs, { isConnection: true });
    },
